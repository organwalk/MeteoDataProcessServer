...
public class ClientController {
    ...
    // 测试该链接以获取code
    // http://localhost:9194/oauth2/authorize?response_type=code&client_id=meteo_client_web&scope=openid&redirect_uri=http://localhost:8080/user/confirm
    ...
    public Result logout(@RequestParam String name){
        return obtainClient.voidToken(name) ? Result.success("success") : Result.fail();
    }
}
